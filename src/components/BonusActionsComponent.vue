...
const attachListeners = async () => {
    ...
    const handleButtonClick = (event) => {
        emit('rollDiceBonusAction', event.target.innerText, "normal");
    };

    const handleButtonRightClick = (event) => {
        emit('rollDiceBonusAction', event.target.innerText, "advantage");
    };

    const handleButtonMiddleClick = (event) => {
        emit('rollDiceBonusAction', event.target.innerText, "disadvantage");
    };
